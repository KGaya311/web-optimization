...
var pizzaElementGenerator = function(i) {
   ...
   pizzaImage.src = "images/pizza-compressor.png";
...
var resizePizzas = function(size) {
  ...
  var pizzaSize = document.getElementsByClassName("randomPizzaContainer");
  var pizzasLength = pizzaSize.length; 
  function changePizzaSizes(size) {
    var newwidth; //defined a variable used to update values for pizza slider

    switch(size) { //check each case for the slider and return the assigned newwidth value
      case "1":
        newwidth = 25;
        break;
      case "2":
    ...
    for (var i = 0; i < pizzasLength; i++) { //loop over each item contained in randomPizzaContainer and update its style.width property to a %
...
function updatePositions() {
   ...
   var scrollup = document.body.scrollTop ;
   var items = document.getElementsByClassName('mover');
   for (var i = 0,len =  items.length; i < len; i++) {
      var phase = Math.sin(( scrollup / 1250) + (i % 5));
